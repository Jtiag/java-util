...
//			}
	...
	/**
	 * 获取完整请求地址(不带请求参数)
	 * example http://www.baidu.com/map/123/cd
	 * @return
	 */
	public static String getRequestPath(HttpServletRequest request){
		return ServerUtils.getServerAddress()+request.getRequestURI();
	}
	
	/**
	 * 获取完整请求地址(带请求参数)
	 * example http://www.baidu.com/map/123/cd?c=12&n=34
	 * @return
	 */
	public static String getRequestUrl(HttpServletRequest request){
		...
		return getRequestPath(request)+queryString;
	}
